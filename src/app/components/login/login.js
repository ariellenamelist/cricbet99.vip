		...
		<div className={mystyle.cardBody}> 
			...
			<div className="card-text">
				<form className={mystyle.form}>
					...
					<p className="mt-1 align-center" style={{marginBottom: '0px', textAlign:'center'}}><a _ngcontent-gwq-c42="" className="mail-link" href="mailto:cricbet99info@gmail.com">cricbet99info@gmail.com</a></p>
